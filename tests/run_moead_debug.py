...
def run_instance(instance_path):
    print(f"\n=============================================")
    print(f" Rodando MOEA/D em {instance_path}")
    print(f"=============================================")
    ...
    alg = MOEAD(
        ref_dirs, n_neighbors=20, prob_neighbor_mating=0.7,
        sampling=TWBiasedSampling(), crossover=OrderCrossover(), mutation=InversionMutation()
    )
    t0 = time.time()
